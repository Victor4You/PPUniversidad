  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        // He mantenido tu lógica de detección, pero podrías usar la IP del VPS directamente si prefieres
        const backendUrl = isLocal
          ? "http://localhost:3001"
          : "http://194.113.64.53:3013"; // Apuntando a tu nuevo VPS en lugar de Vercel
